...
import com.ardy.ardysubmisfunda.alarm.AlarmReceiver
import com.ardy.ardysubmisfunda.databinding.ActivitySettingsBinding
...
class settings : AppCompatActivity() {
    ...
    private fun Findah() {
        val move =  Intent (this@settings, MainActivity::class.java)
        startActivity(move)
    }
