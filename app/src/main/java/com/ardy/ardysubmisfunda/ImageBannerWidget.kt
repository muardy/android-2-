...
class ImageBannerWidget : AppWidgetProvider() {
    ...
    companion object {
        private const val TOAST_ACTION = "com.ardy.TOAST_ACTION"
        const val EXTRA_ITEM = "com.ardy.EXTRA_ITEM"
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action != null) {
            if (intent.action == TOAST_ACTION) {
                ...
                Toast.makeText(context, "Favorite List Number :  $viewIndex", Toast.LENGTH_SHORT).show()
            }
        }
    }
